...
::: {.callout-note}
This section may not be very interesting on the first reading, however this is a situation that comes up fairly often and has some subtlties to consider in continuous time systems especially.
:::
...
Run the system over the times as above, and plot the number of infected indiviuals over time, with the school closures in grey shading:
