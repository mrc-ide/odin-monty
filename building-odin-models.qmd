...
<br> A script containing the code featured in these slides can be downloaded [here](building-odin-models.R).
...
## Inputting parameters (`pars`) {.smaller}
