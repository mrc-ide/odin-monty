...
This `sir()` function creates a `dust_system_generator` object. As its name suggests, we can use this object to generate different versions of our system with different configurations. We pass this object to other functions from `dust2` to create, run and examine our simulations.
