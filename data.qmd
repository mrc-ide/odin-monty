...
The reported values are here are at the *end* of each step, so we rarely see an incidence of 0 except at the very start and end of the simulation. What we really care about are the values at the end of each day though where it reaches a peak:
