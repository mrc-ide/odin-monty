...
::: {.callout-note}
A value of `NA` in the data time series for a given datastream at a given timepoint will indicate missing data for that datastream at that timepoint and the filter will simply ignore that datastream at that timepoint.
:::
