...
We will use the data set [`data/flu_2009.csv`](data/flu_2009.csv). This data file was originally sourced from the supplement material in [@endo_introduction_2019] and the original file can be found [here](https://github.com/akira-endo/Intro-PMCMC/blob/master/assets/andre_estimates_21_02.txt).
