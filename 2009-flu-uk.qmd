...
4. Built a prior distribution for you model parameters using the `monty` DSL.
...
rect(xleft = hol_t[4], ybottom = 0, xright = hol_t[5], 
     ytop = max(data$Cases) * 1.2, 
     col = adjustcolor("lightgreen", alpha.f = 0.3), border = NA)
...
legend("topright", legend = c("Cases", "Summer Holiday", "Half-Term"),
       pch = c(19, NA, NA), col = c("red", "#87CEEB77", "lightgreen"),
       fill = c(NA, "skyblue", "lightgreen"),
...
::: {.callout-note}
Even if the surveillance system was perfect we would expect a difference between the number of *symptomatic* cases and the number of infections as a proportion of flu cases are *asymptomatic* or 'pauci-symptomatic'. 
:::
