...
* As your model grows, you will accumlate a number of coupled support functions that go along with it, and a package is the easiest mechanism for supporting this
...
A good place to look for information on package development is Hadley Wickham and Jenny Byan's ["R packages" book](https://r-pkgs.org/), and to avoid repeating their material we'll just link to it:
